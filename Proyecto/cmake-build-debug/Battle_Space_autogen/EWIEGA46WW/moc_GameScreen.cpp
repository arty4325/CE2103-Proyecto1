...
QT_MOC_LITERAL(3, 25, 11), // "ListaSimple"
QT_MOC_LITERAL(4, 37, 8), // "dataList"
QT_MOC_LITERAL(5, 46, 10) // "moveThings"

    },
    "GameScreen\0dataReceived\0\0ListaSimple\0"
    "dataList\0moveThings"
};
...
void GameScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dataReceived((*reinterpret_cast< const ListaSimple(*)>(_a[1]))); break;
        case 1: _t->moveThings((*reinterpret_cast< const ListaSimple(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameScreen::*)(const ListaSimple & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameScreen::dataReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameScreen::dataReceived(const ListaSimple & _t1)
{
